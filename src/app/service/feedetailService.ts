...
@Injectable()
export class FeeDetailService extends BehaviorSubject<any[]> {
...
this.getClassifications();
  ...
  getStudentFeeDetails (params): Observable<any> {

    return this.http.post(this.serviceApi.urlMethod('getStudentFeeDetails'),JSON.stringify(params),this._options)
  }
